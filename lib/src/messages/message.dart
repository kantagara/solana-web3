...
import 'package:solana_web3_latest/src/programs/address_lookup_table/state.dart';
import 'package:solana_web3_latest/src/transactions/account_meta.dart';
import 'package:solana_web3_latest/src/transactions/transaction_instruction.dart';
import 'package:solana_web3_latest/src/types.dart';
...
class Message extends Serializable {
  ...
  factory Message.compile({
    ...
    for (final AddressLookupTableAccount lookupAccount in addressLookupTableAccounts ?? const []) {
      ...
      for (int i = 0; i < lookupAddresses.length; ++i) {
        ...
        if (meta != null && !meta.isSigner && !programMetasMap.contains(meta.pubkey)) {
    ...
    final List<AccountMeta> staticAccountMetas = staticAccountMetasMap.values.toList(growable: false);
